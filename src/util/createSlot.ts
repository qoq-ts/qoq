import { WebSlotCtx, ConsoleSlotCtx, MixSlotCtx, Slot, SlotAllType } from '../slot/Slot';
...
export const createSlot = <
    ...
    P extends J = J,
    U extends SlotAllType = T extends 'web' ? Slot.Web : T extends 'console' ? Slot.Console : Slot.Mix
  >(type: T, fn: P): Slot<U> => {
